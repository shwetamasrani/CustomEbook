        ...
        try{
            ...
            Session session = Session.getInstance(props, new javax.mail.Authenticator() {
                protected PasswordAuthentication getPasswordAuthentication() {
                    return new PasswordAuthentication("customebookiiitb@gmail.com", "customize21");
                }
            });
            String emailId  = order.getUser_id().getEmail();
            Message msg = new MimeMessage(session);
            msg.setFrom(new InternetAddress("customebookiiitb@gmail.com", false));
            ...
            String text = "Hello " + order.getUser_id().getFirstName() + " ," + "\n" + "Thank you for ordering from CustomEBook. We would like to inform you " +
                    "that your CustomEBook order with Order Number:"+order.getOrderId()+" purchased on " + order.getOrderDate() + " has been processed.\nPlease find attached the PDF File of your book: "
